...
def main():
  outPath = r''
  settingPath = 'data/VPS/VPS_03/lmq/pancreas/pyradiomics/examples'
  inputCSV = os.path.join(outPath, 'data/precontrast_PDAC_radiomics.csv')
 #  inputCSV = os.path.join(outPath, 'precontrast_pan_df.csv')
  outputFilepath = os.path.join(outPath, 'PDAC_radiomics_result.csv')
  progress_filename = os.path.join(outPath, 'pyrad_log.txt')
  params = os.path.join(settingPath, 'exampleSettings', 'Params.yaml')
